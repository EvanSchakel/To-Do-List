...
public class TaskControllerTest {
    ...
    @Test
    void testMalformedJsonPayload_ReturnsBadRequest() throws Exception {
        mockMvc.perform(post("/api/tasks")
                .contentType(MediaType.APPLICATION_JSON)
                .content("{\"title\": \"Test\", \"completed\": \"invalid-boolean\"}"))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$.error").value("Malformed request payload"));
    }

    @Test
    void testTypeMismatchForArgument_ReturnsBadRequest() throws Exception {
