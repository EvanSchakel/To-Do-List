...
public class TaskService {
    ...
    // ⚡ Bolt Performance Optimization:
    // Caching individual task lookups to prevent redundant database queries.
    // Impact: Eliminates database SELECT queries for repeated lookups of the same task,
    // reducing database load and response latency.
