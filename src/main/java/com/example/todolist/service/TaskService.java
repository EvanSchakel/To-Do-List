...
public class TaskService {
    ...
    // ⚡ Bolt Performance Optimization:
    // Cache individual task lookups to reduce database load for frequently accessed single items.
    // Spring automatically unwraps the Optional and caches the underlying Task if present.
